...
class AdminCombinationsControllerCore extends AdminController
{
    public $bootstrap = true;
    protected $position_identifier = 'id_product_option';
    ...
    public function __construct()
    {
        ...
        $this->_defaultOrderBy = 'id_product_option';
    ...
    protected function setTypeFeature()
    {
        $this->table = 'product_option';
        $this->className = 'ProductOption';
        $this->identifier = 'id_product_option';
    }
