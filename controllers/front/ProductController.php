...
class ProductControllerCore extends FrontController
{
    ...
    public function initContent()
    {
        ...
        if (!$this->errors) {
            ...
            $this->context->smarty->assign(array(
                'product_options' => count($product_options) ? $product_options : null,
    ...
    protected function assignAttributesGroups()
    {
        ...
        $test = $this->product->getAttributesGroups($this->context->language->id);
        if (is_array($attributes_groups) && $attributes_groups) {
            ...
            foreach ($attributes_groups as $k => $row) {
                ...
                $groups[$row['id_attribute_group']]['attributes'][$row['id_attribute']]['id_product_attribute'] = $row['id_product_attribute'];
                $groups[$row['id_attribute_group']]['attributes'][$row['id_attribute']]['name'] = $row['attribute_name'];
                $groups[$row['id_attribute_group']]['attributes'][$row['id_attribute']]['price'] = $row['price'];
                $groups[$row['id_attribute_group']]['attributes'][$row['id_attribute']]['weight'] = $row['weight'];
