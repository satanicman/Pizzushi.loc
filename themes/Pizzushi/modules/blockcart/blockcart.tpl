...
{/if}
				...
				<div class="block_content">
					...
					<div class="cart_block_list expanded">
						...
						<p class="cart_block_no_products{if $products} unvisible{/if}">
							<img src="\themes\Pizzushi\img\cart-no-product.png" alt="Проголодались">
							<span>{l s='Проголодались?' mod='blockcart'}</span>
						</p>
		...
		<div class="alert alert-danger" role="alert" id="empty_cart">
			<span class="sr-only">Корзина пуста</span>
			Корзина пуста
		</div>
